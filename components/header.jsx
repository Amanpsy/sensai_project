...
const Header = async() =>  {
  ...
  return (
    ...
    <DropdownMenuContent>
      <DropdownMenuItem>
      <Link href={'/task1'} className='flex items-center gap-2' >
    ...
    <span >Build Resume</span>
      ...
      <Link href={'/task2'} className='flex items-center gap-2' >
      ...
      <Link href={'/task3'} className='flex items-center gap-2' >
       
      <GraduationCap  className='h-4 w-4'/>
      <span >Prepare Interviews</span>
        </Link>
      </DropdownMenuItem>
    </DropdownMenuContent>
  </DropdownMenu>
